...
class CompressionService {
    ...
    compressFiles(inputFiles) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.checkDirectory(directoryPath);
    ...
    handleProcessErrors(compressionErrors, directoryPath) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    treatFiles(inputFiles, directoryPath, treatedFiles) {
    ...
    checkDirectory(directoryPath) {
        return new Promise(resolve => (0, node_fs_1.access)(directoryPath, node_fs_1.constants.F_OK, (err) => {
            if (err) {
